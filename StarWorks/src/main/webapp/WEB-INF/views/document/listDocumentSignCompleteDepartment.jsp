...
<body onload="printClock()">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a
			href="/document/listDocumentSignCompleteDepartment?type=D&keyword=인사">인사</a></li>
		<li class="breadcrumb-item"><a
			href="/document/listDocumentSignCompleteDepartment?type=D&keyword=영업">영업</a></li>
		<li class="breadcrumb-item"><a
			href="/document/listDocumentSignCompleteDepartment?type=D&keyword=개발">개발</a></li>
		<li class="breadcrumb-item"><a
			href="/document/listDocumentSignCompleteDepartment?type=D&keyword=임원">임원</a></li>
		<li class="breadcrumb-item"><a
			href="/document/listDocumentSignCompleteDepartment?type=D&keyword=총무">총무</a></li>
	</ol>
	...
	<div class="panel-body">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<c:forEach items="${list}" var="document">
				<tr style="text-align: center;">
					<td style="width: 100px; height: 20px;"><a class='move'
						href='<c:out value="${document.dc_no}" />'><c:out
								value="${document.dc_no}" /></a></td>
					<td><c:out value="${document.dc_title}" /></td>
					<td><c:out value="${document.dc_drafter} ${document.dep}" /></td>
					<td><fmt:formatDate pattern="yyyy-MM-dd"
							value="${document.dc_date_start}" /></td>
					<td><fmt:formatDate pattern="yyyy-MM-dd"
							value="${document.dc_date_end}" /></td>
		...
		<div class='row'>
			<div class="col-lg-12">
				...
				<form id='searchForm'
					action="/document/listDocumentSignCompleteDepartment" method='get'>
					<select name='type'>
